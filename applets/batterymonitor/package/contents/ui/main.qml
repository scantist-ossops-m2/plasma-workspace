...
PlasmoidItem {
    ...
    Plasmoid.title: hasBatteries ? i18n("Battery and Power") : i18n("Power Management")
    ...
    toolTipSubText: {
        ...
        if (profiles) {
            parts.push(i18n("Scroll to adjust power profile"));
        }
    ...
    Plasmoid.icon: {
        ...
        if (hasBatteries) {
            ...
            iconName = "battery-profile-performance-symbolic";
        }
